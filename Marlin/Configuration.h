...
#define STRING_CONFIG_H_AUTHOR "(TheFalseReality, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -1.15 }
...
#define XY_PROBE_FEEDRATE (133*100)
